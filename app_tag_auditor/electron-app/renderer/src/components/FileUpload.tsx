          ...
          {!isGoogleConnected ? (
            ...
            >
              ...
              {(() => {
                ...
                const url = googleClientId ? buildOAuthUrl(googleClientId, googleRedirectUri) : '#';
                return (
                  <a
                    href={url}
                    target="_blank"
                    ...
                    style={{ fontSize: '0.85rem', padding: '8px 16px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}
                    onClick={(e) => {
                      if (!googleClientId) {
                        e.preventDefault();
